...
public class AESCipherUtil implements ICipher{
    ...
    public String encrypt(String text) throws SecurityException {
        ...
        try {
            ...
            throw new SecurityException("<암호화 에러> = 암호화 중 에러 발생", e);
        }
        return encryptText;
    }

    @Override
    public String decrypt(String encryptText) throws SecurityException{
        ...
        try {
            ...
            throw new SecurityException("<복호화 에러> = 복호화 중 에러 발생", e);
        }
        return plainText;
    }
